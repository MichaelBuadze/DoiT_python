...
# თუ სია უკვე არსებობს, მისი გამოტანა კონსოლში.
if os.path.exists(file_name):
    print() # თავისუფალი სივრცე
    print("დამახსოვრებული სია:")
    print() # თავისუფალი სივრცე
...
if not os.path.exists(file_name):
    ...
    print() # თავისუფალი სივრცე
    print("მიმდინარე რეაგირების შედეგი:")
    print() # თავისუფალი სივრცე
    ...
    enter_student_id = input("სასურველი სტუდენტის ინფორმაციის გამოსატანად შეიყვანეთ მისი ID: ")
